              ...
              <div class="box-footer">
                <div class="row">
                  <div class="col-md-3 pull-right">
                    <a href="code_ranap_final.php?pul=<?php echo $id_pulang; ?>&bulan=<?php echo $bulan; ?>&tahun=<?php echo $tahun; ?>&jpasien=<?php echo $jpasien; ?>" class="btn btn-success btn-md"><i class="fa fa-check"></i> Selesai</a>
                  </div>
                </div>
              </div>
            </div>
