        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="box box-success">
                    <!-- form start -->
                    <form role="form" action="indikator_pelayanan_acc.php" method="get">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="ruang">Jumlah Tempat Tidur <span style="color:red">*</span></label>
                                <input type="text" name="tt" id="tt" class="form-control" placeholder="Masukan Jumlah Real Tempat Tidur" required>
                            </div>
                            <div class="form-group">
