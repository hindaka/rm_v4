...
$get_data = $db->prepare("SELECT r.tanggal,rr.kode_rad_pasien,rr.nama_pasien,r.asal,rr.alamat,rr.kota,r.dokter,rp.jenisperiksa FROM radiologi r INNER JOIN register_radiologi rr ON(r.kode_rad=rr.kode_rad_pasien) INNER JOIN radiologi_p rp ON(r.id_radiologi=rp.id_radiologi) WHERE SUBSTRING(tanggal,4,2)=:bulan AND SUBSTRING(tanggal,7,4)=:tahun AND r.status='2'");
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <li class="active">Register Radiologi</li>
          </ol>
				</section>
        ...
        <section class="content">
					...
					<div class="box box-primary">
						<div class="box-header with-border">
							...
							<h3 class="box-title">Filter Data Rekap Radiologi</h3>
							<div class="pull-right">
								<a href="export_radiologi_luar.php?bulan=<?php echo $bulan; ?>&tahun=<?php echo $tahun; ?>" class="btn btn-sm btn-success"><i class="fa fa-download"></i> Export To Excel</a>
							</div>
						</div>
						<div class="box-body">
