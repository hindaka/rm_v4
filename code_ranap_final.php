...
if($c['total']>0){
	...
	$final->execute();
  echo "<script language=\"JavaScript\">window.location = \"coding_ranap.php?bulan=".$bulan."&tahun=".$tahun."&jpasien=".$jpasien."&status=1\"</script>";
}else{
  echo "<script language=\"JavaScript\">window.location = \"coding_ranap.php?bulan=".$bulan."&tahun=".$tahun."&jpasien=".$jpasien."&status=2\"</script>";
}
