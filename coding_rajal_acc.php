    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="alert alert-info">
          <b>Halaman ini dipergunakan untuk Coding Diagnosa/prosedur Pasien Rawat Jalan.</b><br>
          <span style="color:red">**</span><b style="color:black">Jangan Lupa Klik Tombol Selesai agar data tersimpan ke dalam Rekap Coding Rajal.</b>
        </div>
          ...
          <div class="col-xs-6">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Form Coding Pasien Rawat Jalan</h3>
              </div>
              <div class="box-body">
                <div class="row">
                  <div class="col-xs-4">
              ...
              <div class="box-body">
                <div class="row">
                  <div class="col-xs-12 col-md-8">
                    <div class="form-group">
                      <select name="icd9" id="icd9" class="form-control select_icd9" width="100%">
                      </select>
                    </div>
                  </div>
              ...
              <div class="box-footer">
                <div class="row">
                  <div class="col-md-3 pull-right">
                    <a href="code_rajal_final.php?pul=<?php echo $id_pulang; ?>&bln=<?php echo $bulan; ?>&thn=<?php echo $tahun; ?>&jpasien=<?php echo $jpasien ?>" class="btn btn-success btn-md"><i class="fa fa-check"></i> Selesai</a>
                  </div>
                </div>
