        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Pilih Data Statistik</h3>
            </div>
            <form class="" action="statistik_acc.php" method="get">
            <div class="box-body">
							<div class="form-group">
							  <label for="statistik">Analisis Data</label>
							  <select name="statistik" id="statistik" class="form-control" required>
							  	<option value="">---Pilih Analisis Data---</option>
									<option value="rajalAll">Seluruh Kasus Rawat Jalan</option>
									<option value="ranapAll">Seluruh Kasus Rawat Inap</option>
									<option value="10rajal">10 Kasus Terbanyak Rawat Jalan</option>
									<option value="10ranap">10 Kasus Terbanyak Rawat Inap</option>
									<option value="21all">21 Kasus Terbanyak Rumah Sakit</option>
									<option value="21rajal">21 Kasus Terbanyak Rawat Jalan</option>
									<option value="21ranap">21 Kasus Terbanyak Rawat Inap</option>
							  </select>
							</div>
              <div class="form-group">
