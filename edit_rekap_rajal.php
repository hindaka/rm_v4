								...
								<div class="box-footer">
									<div class="row">
										<div class="col-md-3 pull-right">
												<a href="rekap_coding_rajal.php?pul=<?php echo $id_pulang; ?>&awal=<?php echo $awal; ?>&akhir=<?php echo $akhir; ?>&status=1" class="btn btn-success btn-md"><i class="fa fa-check"></i> Selesai</a>
										</div>
									</div>
