        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Rekap Data Penggunaan NIK</h3>
							<span class="pull-right">
								<a href="export_nik.php?awal=<?php echo $awal; ?>&akhir=<?php echo $akhir; ?>" class="btn btn-success btn-sm"><i class="fa fa-send"></i> Export To Excel</a>
							</span>
            </div>
            <div class="box-body">
